...
export const experiences: ContentRecord[] = [
  ...
  },
  {
    ...
    detailedDescription:
      'Led a squad during patrol-boat operations by assigning duties, training team members, and reporting personnel and equipment readiness. Operated PRC-999K radios, GPS, radar, and harbor communication systems; conducted communication checks with coastal units; monitored communication quality; and inspected the vessel’s electrical distribution panel while performing basic troubleshooting and minor repairs. Operated and maintained military remotely operated vehicles (ROVs) under field conditions and identified that tether cables physically constrained vehicle maneuverability, restricted operating range, and increased the risk of cable entanglement, particularly in complex underwater environments. Based on these operator-level observations, provided conceptual technical input for transitioning from tethered ROV operations to an autonomous underwater vehicle (AUV) system. Recommended that the AUV employ a mission-supervisory state machine that continuously monitors battery state of charge, mission time, operating depth, water-ingress status, propulsion faults, and navigation confidence. Proposed a layered abort-and-recovery strategy in which the vehicle terminates its mission when low battery, depth-limit violations, excessive navigation uncertainty, propulsion or control failures, or prolonged communication loss are detected. If localization remains reliable, the vehicle returns to a predefined recovery waypoint using sensor-fusion navigation based on an inertial measurement unit (IMU), Doppler velocity log (DVL), compass, and depth sensor. If safe return is no longer possible, the vehicle initiates a controlled emergency ascent using positive buoyancy or a drop-weight release mechanism. Also recommended acquiring a GPS position and activating a radio beacon or visual strobe after surfacing to support rapid tracking and recovery. These recommendations were intended to reduce tether-related constraints while improving recoverability, operational safety, and mission reliability in coastal environments.',
...
export const training: ContentRecord[] = [
  ...
  },
  {
    ...
    detailedDescription:
      'This training was conducted by Underwater Solution Co., Ltd., a subsea robotics company founded by an alumnus of the Division of Electrical and Electronic Engineering at Korea Maritime & Ocean University. The program provided an opportunity to understand how electrical and electronic engineering principles are applied to ROV power, communication, control, imaging, and maintenance systems. During the program, I learned the basic configuration and operating principles of ROVs and completed hands-on exercises in deployment and recovery, forward and reverse movement, ascent and descent, directional control, tether management, and camera-based underwater inspection. In particular, I examined how tether tension and entanglement affect vehicle maneuverability and operational range and learned how to maintain stable vehicle positioning and camera visibility during underwater inspections. I also practiced pre- and post-operation inspection procedures for thrusters, tether cables, watertight seals, power and communication connections, cameras, and control systems. I systematically checked the power supply, communication links, thruster operation, and video feed to identify common operational faults and performed basic maintenance tasks such as equipment cleaning, cable organization, and visual inspection. Through this experience, I learned that safe and reliable ROV operation requires not only piloting skills but also systematic pre-operation checks and continuous equipment monitoring.',
    evidenceStatus: 'pending',
    evidenceItems: [],
    featured: false,
    visible: true,
